...
class VirtualDatabase {
  ...
  static final _db = VirtualDatabase._privateConstructor();

  VirtualDatabase._privateConstructor();

  factory VirtualDatabase() {
    return _db;
  }
  ...
  Future<void> update(Map<String, dynamic> updatedItem) async {
    int i = _items.indexWhere((item) => item['id'] == updatedItem);
